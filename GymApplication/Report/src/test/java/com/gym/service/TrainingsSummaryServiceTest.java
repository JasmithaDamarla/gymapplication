...
class TrainingsSummaryServiceTest {
	...
	void addAllTrainingsSummary() {
		...
		Mockito.verify(trainingsSummaryRepository, times(summaryList.size())).insert(any(TrainingsSummary.class));
	}
...
//		Mockito.verify(trainingsSummaryRepository, times(1)).insert(trainingSummary);
	}
}
